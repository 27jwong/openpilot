...
class CarControllerParams:
  def __init__(self, CP):
    ...
    if CP.flags & MazdaFlags.GEN2:
      self.STEER_MAX = 8000
      self.STEER_DELTA_UP = 54              # torque increase per refresh
      self.STEER_DELTA_DOWN = 96            # torque decrease per refresh
      self.STEER_DRIVER_ALLOWANCE = 1800     # allowed driver torque before start limiting
